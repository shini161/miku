        ...
        action: {
            bite: {
                target: {
                    none(
                        ...
                        return [`${author_username} wants to bite something.`,
            ...
            blush: {
                target: {
                    none(
                        ...
                        return [`${author_username} is blushing because of something.`,
                    ...
                    default(author_username: string, target_username: string) {
                        return [`${author_username} is blushing because of ${target_username}.`];
                    }
                }
            },
            boop: {
                target: {
                    ...
                    default(author_username: string, target_username: string) {
                        return [`${author_username} is booping ${target_username}.`,
            ...
            bored: {
                target: {
                    ...
                    default(author_username: string, target_username: string) {
                        return [`${author_username} is bored because of ${target_username}.`];
                    }
                }
            },
            bully: {
            ...
            cry: {
                target: {
                    ...
                    default(author_username: string, target_username: string) {
                        return [`${author_username} is crying because of ${target_username}.`];
                    }
                }
            },
            cuddle: {
                target: {
                    none(
                        ...
                        return [`${author_username} needs to be cuddled!`,
            ...
            happy: {
                target: {
                    none(
                        ...
                        return [`${author_username} is happy!`,
                    ...
                    default(author_username: string, target_username: string) {
                        return [`${author_username} is happy because of ${target_username}!`];
                    }
                }
            },
            highfive: {
            ...
            hold: {
                target: {
                    ...
                    default(author_username: string, target_username: string) {
                        return [`${author_username} is holding ${target_username}'s hands.`,
            ...
            hug: {
                target: {
                    none(
                        ...
                        return [`${author_username} needs a hug!`,
            ...
            kill: {
                target: {
                    ...
                    default(author_username: string, target_username: string) {
                        return [`${author_username} killed ${target_username}!`,
            ...
            kiss: {
                target: {
                    none(
                        ...
                        return [`${author_username} needs a kiss!`,
                    ...
                    default(author_username: string, target_username: string) {
                        return [`${author_username} kissed ${target_username}!`,
            ...
            lick: {
                target: {
                    ...
                    default(author_username: string, target_username: string) {
                        return [`${author_username} is licking ${target_username}.`,
            ...
            nom: {
                target: {
                    none(
                        ...
                        return [`${author_username} wants to nom something.`,
            ...
            pat: {
                target: {
                    ...
                    default(author_username: string, target_username: string) {
                        return [`${author_username} pats ${target_username}.`,
            ...
            run: {
                target: {
                    none(
                        ...
                        return [`${author_username} is running.`,
                    ...
                    default(author_username: string, target_username: string) {
                        return [`${author_username} is running away from ${target_username}.`];
                    }
                }
            },
            sad: {
                target: {
                    ...
                    default(author_username: string, target_username: string) {
                        return [`${author_username} is sad because of ${target_username}...`];
                    }
                }
            },
            shoot: {
            ...
            sip: {
                target: {
                    ...
                    default(author_username: string, target_username: string) {
                        return [`${author_username} is sipping some juice with ${target_username}.`];
                    }
                }
            },
            slap: {
                target: {
                    ...
                    default(author_username: string, target_username: string) {
                        return [`${author_username} slaps ${target_username}.`,
            ...
            sleep: {
                target: {
                    ...
                    default(author_username: string, target_username: string) {
                        return [`${author_username} wants to sleep with ${target_username}!`,
            ...
            stare: {
                target: {
                    ...
                    default(author_username: string, target_username: string) {
                        return [`${author_username} stares at ${target_username}.`,
            ...
            think: {
                target: {
                    none(
                        ...
                        return [`${author_username} is thinking at something.`,
                    ...
                    default(author_username: string, target_username: string) {
                        return [`${author_username} is thinking at ${target_username}.`,
            ...
            tickle: {
                target: {
                    ...
                    default(author_username: string, target_username: string) {
                        return [`${author_username} is tickling ${target_username}.`,
            ...
            triggered: {
                target: {
                    ...
                    default(author_username: string, target_username: string) {
                        return [`${author_username} is triggered because of ${target_username}.`];
                    }
                }
            },
            wave: {
